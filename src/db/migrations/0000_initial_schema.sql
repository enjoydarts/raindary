...
CREATE INDEX IF NOT EXISTS "idx_raindrops_user_id" ON "raindrops" USING btree ("user_id");
CREATE INDEX IF NOT EXISTS "idx_raindrops_synced_at" ON "raindrops" USING btree ("user_id", "synced_at");
CREATE INDEX IF NOT EXISTS "idx_raindrops_collection" ON "raindrops" USING btree ("user_id", "collection_id");
...
CREATE UNIQUE INDEX IF NOT EXISTS "unique_user_raindrop_tone" ON "summaries" USING btree ("user_id", "raindrop_id", "tone");
CREATE INDEX IF NOT EXISTS "idx_summaries_user_raindrop" ON "summaries" USING btree ("user_id", "raindrop_id");
CREATE INDEX IF NOT EXISTS "idx_summaries_status" ON "summaries" USING btree ("user_id", "status");
CREATE INDEX IF NOT EXISTS "idx_summaries_created" ON "summaries" USING btree ("user_id", "created_at");
...
CREATE INDEX IF NOT EXISTS "idx_api_usage_user" ON "api_usage" USING btree ("user_id", "created_at");
